        ...
        <Layout>
            <div className="container contacto mx-auto">
                <div className="row contacto">          
                    <div  className="company-info col-10 col-md-5 col-lg-5 mx-auto">
                        ...
                        <ul>
                            <li><i  className="fa fa-road"></i> CL 14D #43A-34 Manzanares I<br/>Poblado campestre, Candelaria<br/>Cali, Colombia</li>
                            <li><i  className="fa fa-phone"></i> (300) 365-9340</li>
                            <li><i  className="fa fa-envelope"></i> carvajalmateriales@hotmail.com</li>
                        </ul>
                    </div>

                    <div  className="contact col-10 col-md-7 col-lg-7 mx-auto">
                        <h3>Contáctanos</h3>
